<%-- 
    Document   : pizza
    Created on : 06/06/2020, 18:42:01
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-info">
        <h5 class="modal-title text-white" id="exampleModalLabe1">Registrando pizza</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
          <form method="POST" action="RegistraPizzaController?opcao=create">
          <div class="form-group">
            <label for="recipient-name" class="col-form-label" id="nomePizzaid" >Nome pizza: </label>
            
            <input type="text" class="form-control" id="recipient-name" name="nomePizza">
          </div>
          <div class="form-group">
            <label for="message-text" class="col-form-label">Descrição</label>
            <textarea class="form-control" id="message-text" name="descricaoPizza"></textarea>
          </div>
            <div class="form-group">
                
                
                <div class="row">
                <div class="col-6">  <label for="recipient-name" class="col-form-label" >Tamanho base: </label> </div>
                <div class="col-6">  <select class="form-control" id="exampleFormControlSelect1" name="tamanhoPizza">
                ...
                <br>
                <div class="row">
                <div class="col-6">  <label for="recipient-name" class="col-form-label">Valor base: </label> </div>
                <div class="col-6"> <input type="number" name="valorPizza" min="0.00" max="10000.00" step="0.01" class="form-control" id="recipient-name" placeholder="R$" >  </div>
                </div>
                <br>
                 <div class="row">                        
                <div class="col-6">  <label for="recipient-name" class="col-form-label">Acréscimo por tamanho: </label> </div>
                <div class="col-6"> <input type="number" name="acrescimoPizza" min="0.00" max="10000.00" step="0.01" class="form-control" id="recipient-name" placeholder="R$" >  </div>
                </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-warning">
        <h5 class="modal-title text-white" id="exampleModalLabe1">Editando pizza</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
          <form method="POST" action="RegistraPizzaController?opcao=update">
          <div class="form-group">
            <label for="recipient-name" class="col-form-label"  >Nome pizza: </label>
            <input type="text" class="form-control" id="recipient-name" name="nomePizzaEdit">
            <input id="idPizza" name="idPizza" type="text" style="visibility: hidden; position: fixed">
          </div>
          <div class="form-group">
            <label for="message-text" class="col-form-label">Descrição</label>
            <textarea class="form-control" id="message-text" name="descricaoPizzaEdit"></textarea>
          </div>
            <div class="form-group">
                ...
                <div class="row">
                <div class="col-6">  <label for="recipient-name" class="col-form-label" >Tamanho base: </label> </div>
                <div class="col-6">  <select class="form-control" id="exampleFormControlSelect1" name="tamanhoPizzaEdit">
                            <option value="1" >BROTO</option>
                            <option value="2" >PEQUENA</option>
                            <option value="3" >MÉDIA</option>
                            <option value="4" >GRANDE</option>
                ...
                <div class="row">
                <div class="col-6">  <label for="recipient-name" class="col-form-label">Valor base: </label> </div>
                <div class="col-6"> <input type="number" name="valorPizzaEdit" min="0.00" max="10000.00" step="0.01" class="form-control" id="recipient-name" placeholder="R$" >  </div>
                </div>
                <br>
                 <div class="row">                        
                <div class="col-6">  <label for="recipient-name" class="col-form-label">Acréscimo por tamanho: </label> </div>
                <div class="col-6"> <input type="number" name="acrescimoPizzaEdit" min="0.00" max="10000.00" step="0.01" class="form-control" id="recipient-name" placeholder="R$" >  </div>
                </div>
...
<!-- -->
            ...
            <div class="container-fluid">
                ...
                <h3 class="text-dark mb-4">Pizza</h3>
                 <button type="button" class="btn btn-info" data-toggle="modal" data-target="#exampleModal" ><i class="fas fa-plus-circle"></i> Registra pizza</button>

                </div>
                <br>
                <div class="card shadow">
                    <div class="card-header py-3 bg-info">
                        <p class="text-white m-0 font-weight-bold"><i class="fas fa-th-list"></i></p>
                    </div>
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                            <table class="table my-0" id="dataTable">
                                ...
                                <tbody>
                                 ...
                                 <!-- LISTANDO PIZZA -->
                                 <%  
                                    RegistraPizzaController pizzaLista = new RegistraPizzaController();
                                    ResultSet rs = pizzaLista.ListarPizza();
                                     while(rs.next()){
    ...
    <script src="pages/assets/js/theme.js"></script>
      <script src="pages/assets/js/RegisterPizza.js"></script>
